...
export const About = () => {
  return (
    <section className="flex flex-col m-auto  items-center gap-12 w-[1440px] h-[992px] bg-[#F9FAFB] py-[96px] px-[80px]">
      <div className="flex flex-col w-[1280px] h-[770px] py-0 px-9 gap-12">
